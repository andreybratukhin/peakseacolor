...
" Maintainer:	Andrey Bratukhin 
" URL:		http://abratukhin.blogspot.com/
" Last Change:	12 January 2012
" Version:	1.0
"
"	Comments and e-mails are welcomed, thanks.
"
"	The current version of psc color schema is based on 
"       http://vim.sourceforge.net/scripts/script.php?script_id=760
"
"       The differences are only for light background colors.
"
...
if &background=='light' 
  ...
  hi LineNr		guifg=#686868	guibg=#b0b0b0   gui=NONE
  hi Question		guifg=#909090	guibg=NONE	gui=NONE
